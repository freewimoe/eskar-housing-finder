...
NEIGHBORHOOD_SUEDSTADT = 'Südstadt'
NEIGHBORHOOD_MUEHLBURG = 'Mühlburg'
NEIGHBORHOOD_GROETZINGEN = 'Grötzingen'
NEIGHBORHOOD_RUEPPURR = 'Rüppurr'
import pandas as pd
import hashlib
import os
...
class ESKARRealEstateAPI:
    ...
    def _generate_enhanced_synthetic_data(self, filters: Dict) -> List[PropertyData]:
        ...
        neighborhoods_data = {
            ...
            NEIGHBORHOOD_SUEDSTADT: {'price_per_sqm': 4000, 'typical_size': 85, 'trend': 'stable'},
            ...
            NEIGHBORHOOD_MUEHLBURG: {'price_per_sqm': 3400, 'typical_size': 100, 'trend': 'stable'},
            ...
            NEIGHBORHOOD_GROETZINGEN: {'price_per_sqm': 3300, 'typical_size': 115, 'trend': 'stable'},
            'Graben - Neudorf': {'price_per_sqm': 2800, 'typical_size': 130, 'trend': 'stable'},
            NEIGHBORHOOD_RUEPPURR: {'price_per_sqm': 3700, 'typical_size': 100, 'trend': 'rising'}
        }
        ...
        for i in range(max_results):
            # Select neighborhood
            neighborhood = self._weighted_neighborhood_selection()
            ...
            property_data = self._create_realistic_property(
                i, neighborhood, neighborhood_info
            )
    ...
    def _weighted_neighborhood_selection(self) -> str:
        ...
        esk_preferences = {
            ...
            NEIGHBORHOOD_SUEDSTADT: 0.15,      # Family - friendly
            ...
            NEIGHBORHOOD_MUEHLBURG: 0.06,      # Affordable option
            'Pfinztal': 0.05,      # Suburban family area
            'Nordstadt': 0.04,     # Central location
            NEIGHBORHOOD_RUEPPURR: 0.04,       # Close to ESK
            NEIGHBORHOOD_GROETZINGEN: 0.03,    # Quiet residential
    ...
    def _create_realistic_property(self, index: int, neighborhood: str,
                                 neighborhood_info: Dict) -> PropertyData:
    ...
    def _generate_neighborhood_coordinates(self, neighborhood: str) -> Tuple[float, float]:
        ...
        centers = {
            ...
            NEIGHBORHOOD_GROETZINGEN: (49.0150, 8.5200),
            'Graben - Neudorf': (49.1500, 8.4800),
            NEIGHBORHOOD_RUEPPURR: (48.9800, 8.4200)
        }
    ...
    def _generate_property_description(self, property_type: str, bedrooms: int,
        ...
        description += " Ideal für internationale Familien - nur wenige Minuten zur European School Karlsruhe."
